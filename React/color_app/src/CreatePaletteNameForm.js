    ...
    return (
      <Dialog open={this.props.stage === "form"} onClose={this.handleClose}>
        ...
        <ValidatorForm onSubmit={this.handleSubmit}>
          <DialogContent>
            <DialogContentText>
              Hey Give a unique Palette name... Remember we will double check
              the palette name, if any palette exists with your given name we'll
              not allow you to create a Palette.....
            </DialogContentText>
